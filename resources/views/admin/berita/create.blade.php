    ...
    <div class="bg-[#0f172a] border border-gray-800 rounded-xl p-6">
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" required class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:ring-indigo-500 focus:border-indigo-500" placeholder="Contoh: Kunjungan Mahasiswa ke Ngawi">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="penulis" required class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white" placeholder="Nama Penulis">
                </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="isi" rows="10" required class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:ring-indigo-500 focus:border-indigo-500" placeholder="Tuliskan isi berita di sini..."></textarea>
            </div>
